...
<main class="p-products">
  ...
  <section>
    <div class="l-contents">
      <div class="l-wapper">
        <h2 class="c-hd__02-02">単品商品一覧</h2>
        ...
        <div class="p-products__block p-products__cv-hd">
          <a class="p-products__cv-link" href="<?php echo home_url(); ?>/products-set">
            <h3 class="p-products__cv-tit">もらってうれしい、<br class="u-use-sp">深井醤油の御進物セットを、<br>全国へお届けいたします。<br>歴史と伝統ある深井醤油の<br class="u-use-sp">御進物セットは贈り物に最適です。
							</h3>
            <div class="p-products__cv-btn">
              <div class="c-btn__re" href="<?php echo home_url(); ?>/story">御進物・ギフト用の<br class="u-use-sp">セット商品はこちら
              </div>
            </div>
          </a>
        </div>
